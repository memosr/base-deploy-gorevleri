# 🔵 Base Ağında 10 Solidity Kontratı

> Guild üzerindeki **Contracts Deployed: 10+** görevini tamamlamak için hazırladığım,  
> her biri farklı bir konsepte sahip 10 özgün Solidity kontratı.
...
3. İstediğin kontrat kodunu yapıştır
4. Sol menü → **Solidity Compiler** → **Compile**
5. Sol menü → **Deploy & Run Transactions**
6. Environment → **Injected Provider - MetaMask**
7. MetaMask'ta **Base** ağını seç
8. **Deploy & Verify** tıkla → MetaMask'ta onayla
